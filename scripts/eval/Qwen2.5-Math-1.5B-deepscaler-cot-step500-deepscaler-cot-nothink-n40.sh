...
export MODEL_PATH="/hpc2hdd/home/zyang398/yangzhch6/projs/reasoning_baselines/rllm/checkpoints/reasoning_baselines/Qwen2.5-Math-1.5B-deepscaler-cot-nothink-3k/global_step_500/actor_huggingface"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='Qwen2.5-Math-1.5B-deepscaler_cot-step500-deepscaler_cot-nothink-3k-n40' \
