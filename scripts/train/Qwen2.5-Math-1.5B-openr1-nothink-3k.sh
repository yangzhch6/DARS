...
export MODEL_PATH="/mnt/weka/home/yongxin.wang/workspace/yangzhch6/models/Qwen/Qwen2.5-Math-1.5B"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='Qwen2.5-Math-1.5B-openr1-nothink-3k' \
