...
export SAVE_PATH="/mnt/weka/home/yongxin.wang/workspace/yangzhch6/rvlr-baseline/checkpoints/sft_debug/Qwen2.5-1.5B-step-0100"
...
torchrun --standalone --nnodes=1 --nproc_per_node=8 -m verl.trainer.fsdp_sft_trainer \
    data.train_files=/mnt/weka/home/yongxin.wang/workspace/yangzhch6/RLVR-Verify-Data/sft_critique/Qwen2.5-1.5B-openr1/0-100_val.parquet \
    ...
    trainer.experiment_name=Qwen2.5-7B-step-100-sp2 \
