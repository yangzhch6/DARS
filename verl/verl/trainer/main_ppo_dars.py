...
from verl.trainer.ppo.ray_dars_trainer import RayPPOTrainer
from verl.trainer.math_verify_reward import reward_fn_math_verify, reward_fn_math_verify_no_think, reward_fn_math_verify_no_think_no_code, reward_fn_true_false
...
def _select_rm_score_fn(data_source, reward_impl_version):
    ...
    elif reward_impl_version == 4: # no_think no_code
        return reward_fn_true_false
    else:
...
class RewardManager():
    ...
    def __call__(self, data: DataProto):
        ...
        def process_item(args):
            ...
            if self.reward_impl_version == 1 and prompt_str.endswith(THOUGHT_DELIMITER_START + '\n'): # if think
...
def main_task(config):
    ...
    from verl.trainer.ppo.ray_dars_trainer import ResourcePoolManager, Role
