...
class FSDPSFTTrainer(object):
    ...
    def save_checkpoint(self, step, suffix='global_step_{}'):
        # save checkpoint
        ...
        path = os.path.join(self.config.trainer.default_local_dir, suffix.format(step))
        ...
        for epoch in range(self.config.trainer.total_epochs):
            ...
            for data in tqdm(self.train_dataloader,
                ...
                if global_step >= self.total_training_steps:
                    ...
                    self.save_checkpoint(step=global_step, suffix='final_checkpoint')
                    return
